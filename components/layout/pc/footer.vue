<template>
  <footer id="footer" class="footer">
      <el-row class="footer-row" style="    padding: 2em 0 2em 0;">
        <el-col :span="4">
          <dl class="site-link">
            <dt>产品</dt>
          ...
          <dl class="site-link">
              <dt>关注</dt>
                ...
                <dd>
                   <ul class="sn-inline">
                        <li>
                            <a class="entypo-wechart" href="http://weibo.com/segmentfault" >
                        ...
                        <li>
                            ...
                            <a href="http://weibo.com/segmentfault" target="_blank" class="entypo-weibo icon-sn-weibo">
                            <svg class="icon" aria-hidden="true" style="width: 25px;height: 25px;">
                        ...
                        <li>
                            <svg class="icon" aria-hidden="true" style="width: 25px;height: 25px;">
                              <use xlink:href="#youyd-icon-github"></use>
                            </svg>
                            <a href="https://github.com/SegmentFault" target="_blank" class="entypo-facebook icon-sn-github"></a>
                        </li>
