<template>
  <div id="share">
    <div :class="{ mobile: isMobile }" class="share-box">
      <a
      ...
      >
        <i :class="`icon-${social.icon || social.class || social.name}`" class="iconfont"/>
      </a>
  ...
  methods: {
    ...
    shareWindow(social, url) {
      ...
      /*
        ...
        */
      // 给打开的窗口命名
      const windowName = '分享 codeif.tech'
      // 窗口宽度,需要设置
